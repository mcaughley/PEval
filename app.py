# app.py - FINAL FIXED: Robust extraction, clean address, elegant title page, editable footer table, no spilling
...
if uploaded_file is not None:
    try:
        ...
        # Robust parameter extraction (very flexible regex)
        params = {}
